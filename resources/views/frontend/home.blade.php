<x-layouts.frontend>
		...
		<section id="banner-one">
			<div class="swiper-container banner-slider-two" data-swiper-config='{"loop": true, "effect": "slide", "prevButton":"#banner-nav-prev", "nextButton": "#banner-nav-next", "speed": 700, "autoplay": 500000, "paginationClickable": true}'>
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide" data-bg-image="/frontend/media/banner/4.jpg" data-parallax="image">

						<div class="slider-content-two text-left" data-animate="fadeIn">
							<img src="/frontend/media/banner/1.png" alt="Music">
					...
					<div class="swiper-slide" data-bg-image="/frontend/media/banner/3.jpg" data-parallax="image">

						<div class="slider-content-two text-left" data-animate="fadeIn">
							<img src="/frontend/media/banner/2.png" alt="Music">
							<h3 data-animate="fadeInUp">Jazz With</h3>
							<h2 data-animate="fadeInUp" data-delay="0.5s">
								Spanish Make<br> your Feel
							</h2>
				...
				<div class="header_player">
					<div class="tim-container ">
						...
						<div class="player-container">
							...
							<div id="header_player" class="jp-audio" role="application" aria-label="/frontend/media player">
						...
						<div class="row">
							<div class="col-xl-3 col-lg-4 col-sm-6 col-md-6">
								<div class="album-box album-box-two">
									<div class="box-thumb">
										<img src="/frontend/media/tranding-album/7.jpg" alt="album">
							...
							<div class="col-xl-3 col-lg-4 col-sm-6 col-md-6">
								<div class="album-box album-box-two">
									<div class="box-thumb">
										<img src="/frontend/media/tranding-album/8.jpg" alt="album">
										<div class="icon float-right">
											<i class="tim-headphones"></i>
										</div>
									</div>
							...
							<div class="col-xl-3 col-lg-4 col-sm-6 col-md-6">
								<div class="album-box album-box-two">
									<div class="box-thumb">
										<img src="/frontend/media/tranding-album/9.jpg" alt="album">
										<div class="icon float-right">
											<i class="tim-headphones"></i>
										</div>
									</div>
							...
							<div class="col-xl-3 col-lg-4 col-sm-6 col-md-6">
								<div class="album-box album-box-two">
									<div class="box-thumb">
										<img src="/frontend/media/tranding-album/10.jpg" alt="album">
										<div class="icon float-right">
											<i class="tim-headphones"></i>
										</div>
									</div>
							...
							<div class="col-xl-3 col-lg-4 col-sm-6 col-md-6">
								<div class="album-box album-box-two">
									<div class="box-thumb">
										<img src="/frontend/media/tranding-album/11.jpg" alt="album">
										<div class="icon float-right">
											<i class="tim-headphones"></i>
										</div>
									</div>
							...
							<div class="col-xl-3 col-lg-4 col-sm-6 col-md-6">
								<div class="album-box album-box-two">
									<div class="box-thumb">
										<img src="/frontend/media/tranding-album/12.jpg" alt="album">
										<div class="icon float-right">
											<i class="tim-headphones"></i>
										</div>
									</div>
							...
							<div class="col-xl-3 col-lg-4 col-sm-6 col-md-6">
								<div class="album-box album-box-two">
									<div class="box-thumb">
										<img src="/frontend/media/tranding-album/13.jpg" alt="album">
										<div class="icon float-right">
											<i class="tim-headphones"></i>
										</div>
									</div>
							...
							<div class="col-xl-3 col-lg-4 col-sm-6 col-md-6">
								<div class="album-box album-box-two">
									<div class="box-thumb">
										<img src="/frontend/media/tranding-album/14.jpg" alt="album">
										<div class="icon float-right">
											<i class="tim-headphones"></i>
										</div>
									</div>
		...
		<!--=        	Artitst         =-->
		<!--=============================-->
		<section id="artist" class="section-padding section-dark" data-parallax="image" data-bg-image="/frontend/media/background/1.jpg">
			<div class="container">
				<div class="section-title text-center">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-full-width">
						<div class="artist-image">
							<img src="/frontend/media/artist/1.jpg" alt="artist">
						</div>
						<!-- /.artist-image -->
					</div>
					...
					<div class="col-lg-6 col-md-6 col-full-width">
						<div class="artist-details">
							...
							<div class="details">
								...
								<img src="/frontend/media/artist/2.png" alt="Artist- Sing" class="sng">
							</div>
						</div>
						<!-- /.artist-details -->
					</div>
		...
		<!--=        	Upcoming         =-->
		<!--==============================-->
		<section id="upcoming-concerts-two" class="section-padding" data-bg-image="/frontend/media/background/6.jpg">
			<div class="tim-container">
				<div class="section-title text-center">
					<h2>Trending Albums <span>Hightlights</span></h2>
					<p>
				...
				<div class="concerts-wrapper">
					<div class="concerts concerts-two">
						...
						<div class="concert-details">
							<img src="/frontend/media/concerts/1.jpg" alt="Concerts">
							<div class="content">
					...
					<div class="concerts concerts-two">
						<div class="concert-details">
							<img src="/frontend/media/concerts/2.jpg" alt="Concerts">
							<div class="content">
					...
					<div class="concerts concerts-two">
						<div class="concert-details">
							<img src="/frontend/media/concerts/3.jpg" alt="Concerts">
							<div class="content">
					...
					<div class="concerts concerts-two">
						<div class="concert-details">
							<img src="/frontend/media/concerts/4.jpg" alt="Concerts">
							<div class="content">
		...
		<!--=        	Ticket         	 =-->
		<!--==============================-->
		<section id="ticket" class="parallax" data-speed="0.-3" data-height="700px" data-bg-image="/frontend/media/background/2.jpg">
			<div class="tim-container">
				<div class="row">
					<div class="col-lg-8">
					...
					<ul class="products product-two tim-product-view swiper-wrapper">
						<li class="product product-two clearfix swiper-slide">
							<div class="product-thumb">
								<a href="shop-single.html"><img src="/frontend/media/product/1.jpg" class="attachment-shop_catalog" alt="Product"></a>
						...
						<li class="product product-two clearfix swiper-slide">
							<div class="product-thumb">
								<a href="shop-single.html"><img src="/frontend/media/product/2.jpg" class="attachment-shop_catalog" alt="Product"></a>
						...
						<li class="product product-two clearfix swiper-slide">
							<div class="product-thumb">
								<a href="shop-single.html"><img src="/frontend/media/product/3.jpg" class="attachment-shop_catalog" alt="Product"></a>
						...
						<li class="product product-two clearfix swiper-slide">
							<div class="product-thumb">
								<a href="shop-single.html"><img src="/frontend/media/product/4.jpg" class="attachment-shop_catalog" alt="Product"></a>
								...
								<div class="quickview-slider">
									<div class="slider-for1">
										<div class="slick-slide">
											<img src="/frontend/media/product/3.jpg" alt="Thumb">
										</div>
										<div class="slick-slide">
											<img src="/frontend/media/product/4.jpg" alt="thumb">
										</div>
										<div class="slick-slide">
											<img src="/frontend/media/product/5.jpg" alt="thumb">
										</div>
									</div>
									...
									<div class="slider-nav1">
										<div class="slick-slide">
											<div class="slide-img">
												<img src="/frontend/media/product/10.jpg" alt="Thumb">
											</div>
										</div>
										<div class="slick-slide">
											<img src="/frontend/media/product/11.jpg" alt="thumb">
										</div>
										<div class="slick-slide">
											<img src="/frontend/media/product/13.jpg" alt="thumb">
										</div>
									</div>
								</div>
								<!-- /.quickview-slider -->
		...
		<!--=        	Intro Video         	 =-->
		<!--======================================-->
		<section id="video-intro" data-bg-image="/frontend/media/background/4.jpg">
			<div class="tim-container">
						...
						<div class="row">
							<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-full-width">
								<div class="lesson-box">
									<img src="/frontend/media/lesson/1.jpg" alt="lesson">
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-full-width">
								<div class="lesson-box">
									<img src="/frontend/media/lesson/2.jpg" alt="lesson">
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-full-width">
								<div class="lesson-box">
									<img src="/frontend/media/lesson/3.jpg" alt="lesson">
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-full-width">
								<div class="lesson-box">
									<img src="/frontend/media/lesson/4.jpg" alt="lesson">
				...
				<div class="row">
					<div class="col-xl-3 col-lg-6 col-sm-6">
						<article class="blog-post-grid">
							...
							<img src="/frontend/media/blog/1.jpg" alt="thumb">
						</a>
							</div>
					...
					<div class="col-xl-3 col-lg-6 col-sm-6">
						<article class="blog-post-grid">
							...
							<div class="feature-image">
								<a href="blog-single.html">
							<img src="/frontend/media/blog/2.jpg" alt="thumb">
						</a>
							</div>
					...
					<div class="col-xl-3 col-lg-6 col-sm-6">
						<article class="blog-post-grid">
							...
							<div class="feature-image">
								<a href="blog-single.html">
							<img src="/frontend/media/blog/3.jpg" alt="thumb">
						</a>
							</div>
					...
					<div class="col-xl-3 col-lg-6 col-sm-6">
						<article class="blog-post-grid">
							...
							<div class="feature-image">
								<a href="#">
							<img src="/frontend/media/blog/4.jpg" alt="thumb">
						</a>
							</div>
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="brand-logo">
								<img src="/frontend/media/logo/1.png" alt="Brand Logo">
							</div>
						</div>

						<div class="swiper-slide">
							<div class="brand-logo">
								<img src="/frontend/media/logo/2.png" alt="Brand Logo">
							</div>
						</div>

						<div class="swiper-slide">
							<div class="brand-logo">
								<img src="/frontend/media/logo/3.png" alt="Brand Logo">
							</div>
						</div>

						<div class="swiper-slide">
							<div class="brand-logo">
								<img src="/frontend/media/logo/4.png" alt="Brand Logo">
							</div>
						</div>
						<div class="swiper-slide">
							<div class="brand-logo">
								<img src="/frontend/media/logo/5.png" alt="Brand Logo">
							</div>
						</div>
					</div>
				</div>
